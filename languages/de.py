...
'Adress: Street, Number, ZIP and City': 'Adress: Street, Number, ZIP and City',
...
'Appartment Code': 'Appartment Code',
"Appartment name/number/code, e.g. 'OG-links', 'Room 602', '3.OG, rechts": "Appartment name/number/code, e.g. 'OG-links', 'Room 602', '3.OG, rechts",
...
'FAQ': 'FAQ',
'file': 'file',
'First (and last) name of child': 'First (and last) name of child',
...
'please figure out how to write a meaningful error message from within this function': 'please figure out how to write a meaningful error message from within this function',
