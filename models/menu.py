...
def _():
    ...
    response.menu = [
        ...
        (T('Book'), False, 'http://www.web2py.com/books/default/'),
    ]

    if auth.has_membership('registered'):
        response.menue.append(
            (T('grid_accommodation'), False, URL('asylum', 'grid_accommodation')),
        )

    #response.menu_defunctMSW += [
